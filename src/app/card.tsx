...
const Card = () => {
  return (
    <div >
        <div className='flex justify-between mt-20 px-10 lg:px-16'>
            <div>
        ...
        <div className='flex justify-evenly flex-wrap gap-x-4 px-10 mt-10'>
         
        <div>
             <div className='w-441.36 h-441.36 mb-6 overflow-hidden'>
                <Image
