...
<div className='mt-20 mb-20'>
        ...
        <div className='flex justify-evenly items-center mb-16 md:mb-28 flex-wrap m-20'>

        <div className='w-700 h-[540px] overflow-hidden mb-14 md:my0 '>
            <Image
            ...
            <div className='w-600 h-[540px] overflow-hidden mb-14 md:my0 '>
            <Image
            className='hover:scale-105 duration-300'
